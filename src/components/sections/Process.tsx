    ...
    <section id="process" className="py-24 px-6 bg-[#F4F4F5]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 relative">
          {/* Connecting line */}
          <div className="hidden lg:block absolute top-8 left-[10%] right-[10%] h-px bg-gradient-to-r from-transparent via-[#D4D4D8] to-transparent" />
          ...
          {processSteps.map((step, i) => (
            <ScrollReveal key={step.step} delay={i * 0.12} direction="up">
              <div className="relative text-center lg:text-left">
                ...
                <div className="hidden lg:flex absolute top-7 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[#C9A84C] ring-4 ring-[#F4F4F5] z-10" />
                <h3
